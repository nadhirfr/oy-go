...
func Create(data *CreateParams) (*oygo.ScheduledDisbursementResult, *oygo.Error) {
	return CreateWithContext(context.Background(), data)
}

// CreateWithContext creates new invoice with context
func CreateWithContext(ctx context.Context, data *CreateParams) (*oygo.ScheduledDisbursementResult, *oygo.Error) {
...
func Get(data *GetParams) (*oygo.ScheduledDisbursementGet, *oygo.Error) {
	return GetWithContext(context.Background(), data)
}

// GetWithContext gets one invoice with context
func GetWithContext(ctx context.Context, data *GetParams) (*oygo.ScheduledDisbursementGet, *oygo.Error) {
	client, err := getClient()
	if err != nil {
		return nil, err
	}
